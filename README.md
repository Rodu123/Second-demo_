...
2. Place your own profile picture as `photo.png` in the project folder.
3. Open `index.html` in any modern browser.
4. Customize the content:
   - Update your **name**, **bio**, **age**, and **city**.
...
- Enhance the design with hover effects and animations.
